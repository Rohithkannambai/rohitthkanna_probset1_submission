...
interface CaseReviewHeaderProps {
  onOverlaySelect?: (overlay: 'about' | 'policy' | 'communityGuidelines') => void;
}

export const CaseReviewHeader: React.FC<CaseReviewHeaderProps> = ({ onOverlaySelect }) => {
  ...
  return (
    <>
      <header
        id="case-review-header"
        className="fixed top-0 left-0 w-full z-40 bg-white/95 backdrop-blur-md border-b border-[#EAE5DC] shadow-[0_1px_6px_rgba(38,30,26,0.03)]"
      >
        {/* =========================================================================
            A. DESKTOP SCREEN 2 HEADER
            LEFT: approved Ting Ting logo, TING TING
            CENTER: SAFETY REVIEW
            RIGHT: Maya Tan, Content Moderator, approved avatar
            (NO Search Case ID)
            ========================================================================= */}
        <div className="hidden md:flex h-20 w-full px-6 lg:px-12 items-center justify-between relative">
          ...
          {/* Center: Safety Review (Optically Centered) */}
          ...
          {/* Right: Maya Tan Moderator Profile */}
        ...
        {/* =========================================================================
            B. MOBILE SCREEN 2 HEADER
            LEFT: Hamburger + Logo + TING TING
            CENTER: SAFETY REVIEW
            RIGHT: Avatar
            (NO Search toggle)
            ========================================================================= */}
          ...
          <div className="px-4 py-2 flex items-center justify-between gap-1.5 h-12">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <div className="relative" ref={mobileHamburgerRef}>
                ...
                {isHamburgerOpen && (
                  <div
                    id="mobile-review-hamburger-popover"
      ...
      {/* Maya Tan Employee Profile Popover Modal */}
      {isProfileOpen && (
        <div
          id="review-profile-popover-overlay"
        ...
        >
          <div
            id="review-profile-popover-card"
